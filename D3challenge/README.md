...
3. Inside your local git repository, create a directory for the D3 challenge. Use the folder name to correspond to the challenge: **https://github.com/HIna-Ahmad/D3-Challenge.git**.
